...
namespace Pulp.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new PulpProjectUser { UserName = Input.Email, Email = Input.Email, BirthDate = Input.BirthDate, Address = Input.Address };
                ...
                if (result.Succeeded)
                {
                    ...
                    bool emailResponse = emailHelper.SendEmail(user.Email, $"Please confirm your account by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
