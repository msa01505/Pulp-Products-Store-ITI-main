...
namespace Pulp.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public ExternalLoginModel(
            ...
            IEmailSender emailSender, IBuyerRepoService buyerRepoService)
        {
            _signInManager = signInManager;
            _userManager = userManager;
            _logger = logger;
            _emailSender = emailSender;
            this.buyerRepoService = buyerRepoService;
        }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                var user = new PulpProjectUser { UserName = Input.Email, Email = Input.Email };
