        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingNom = table.Column<int>(type: "int", nullable: false),
                    ApartmentNom = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Describtion = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PicUri = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CatrgoryTypeID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryTypes", x => x.CatrgoryTypeID);
                    table.ForeignKey(
                        name: "FK_CategoryTypes_Businesses_BusinessID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryItems_CategoryTypes_CategoryTypeId",
                        column: x => x.CategoryTypeId,
                        principalTable: "CategoryTypes",
                        principalColumn: "CatrgoryTypeID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipToAddressAddressID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Addresses_ShipToAddressAddressID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryItems_CategoryTypeId",
                table: "CategoryItems",
                column: "CategoryTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryTypes_BusinessID",
                table: "CategoryTypes",
                column: "BusinessID");
